...
class BotConsole(UniswapBot):
    ...
    def __init__(self):
        ...
        logging.debug(f"max_slippage {self.max_slippage}")
        ...
        #logging.debug(f"pool_info: {pool_info}")
...
if __name__=='__main__':    
    bc = BotConsole()
    text = input("\n\n*** Uniswap bot *** \nBalance (B)  Reserves (R)\n")  # Python 3
    if text == "B":
        print ("show balances")
        print ("target token ",bc.target_token)
        bc.show_balance_info()
